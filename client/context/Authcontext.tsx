            ...
            try {
                ...
                if (data) {
                    const updated: StoredUser = {
                        ...
                        email: data.email,
                        recoveryEmail: data.recoveryEmail || storedUser.recoveryEmail || "",
                        phoneNumber: data.phoneNumber || storedUser.phoneNumber || "",
                        bio: data.bio || storedUser.bio || "",
                        role: data.role || "student",
                        avatar: data.avatar || storedUser.avatar || "",
                        privacySettings: data.privacySettings || storedUser.privacySettings,
